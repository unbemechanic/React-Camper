...
import { DirectContainer, DirectH, Header, IndentedDiv, MenuButton, SignIconsBlur } from '../../style'
        ...
        <IndentedDiv>
            <Header>
                ...
                <DirectContainer>
                    ...
                    <SLink to="/camping"><DirectH>Camping Place<svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="gray"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg></DirectH></SLink>
                </DirectContainer>
