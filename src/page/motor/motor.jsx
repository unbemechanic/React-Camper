...
import { BodyDiv, BodyIcons, BoxingCars, CompareDiv, ComparingCar, Cost, Heading, IndentedDiv, InfoNav, MainBodyDiv, MainSideBar, MotorH, MotorHome, MotorNavIn, NavBoxStyle, NavButton, SelectBox, StylingBoxes } from '../../style';
        ...
        <BodyDiv>
            ...
            <IndentedDiv $motorBody>
                <MainSideBar>
                    ...
                    <NavBoxStyle>
                        <label for="Brand">
                            <SelectBox id="Brand" name='Brand'>
                                <option value="Brand">Brand</option>
                            </SelectBox>
                        </label>
                        <label>
                            <input type='checkbox'/> Aidal
                        </label>
                        <label>
                            <input type='checkbox'/> Knal
                        </label>
                        <label>
                            <input type='checkbox'/> escape
                        </label>
                        
                    </NavBoxStyle>
                    <NavBoxStyle>
                        <label for="Company">
                            <SelectBox id="Company" name='Company'>
                    ...
                    <NavBoxStyle>
                        <label for="License type">
                            <SelectBox id="License type" name='License type'>
                    ...
                    <NavBoxStyle>
                        <label for="travelers">
                            <SelectBox id="travelers" name='travelers'>
                    ...
                    <NavBoxStyle>
                        <label for="Location">
                            <SelectBox id="Location" name='Location'>
                                <option value="Location">Location</option>
                            </SelectBox>
                        </label>
                        <label>
                            <input type='checkbox'/> Seoul
                        </label>
                        <label>
                            <input type='checkbox'/> Busan
                        </label>
                        <label>
                            <input type='checkbox'/> Gwangju
                        </label>
                    </NavBoxStyle>
                    ...
                    <InfoNav>
                        ...
                        <div>
                            <label for="Sort"> Sort by 
                                ...
                                <select id="Sort" name='Sort'>
                                    <option value="Sort"><input style={{width:'30px'}} type='number'/>60</option>
                                </select>
                                <BodyIcons>
